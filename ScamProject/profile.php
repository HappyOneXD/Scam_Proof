...
$stmt = $conn->prepare("SELECT username, gender, dob, created_at, status FROM users WHERE id=?");
        ...
        <div class="container">
            ...
            <div class="profile-card">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($user['gender']); ?>"
                        readonly>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($user['dob']); ?>"
                        readonly>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($user['status']); ?>"
                        readonly>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo $user['created_at']; ?>" readonly>
